...
/* themes/custom/clean/templates/menu--footer.html.twig */
class __TwigTemplate_4d7f05591ecc9a32c8b7be038917c97e889bef6acf00f0f583091a656e3cb793 extends Twig_Template
{
...
";
        ...
        try {
            ...
            if ((isset($context["items"]) ? $context["items"] : null)) {
                ...
                if (((isset($context["menu_level"]) ? $context["menu_level"] : null) == 0)) {
                    // line 30
                    echo "      <ul";
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "menu", 1 => "footer-nav", 2 => "nav", 3 => "clearfix"), "method"), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 32
  ...
  ";
    ...
    {
        return "themes/custom/clean/templates/menu--footer.html.twig";
    }
...
/*   {% if items %}*/
/*     {% if menu_level == 0 %}*/
/*       <ul{{ attributes.addClass('menu', 'footer-nav', 'nav', 'clearfix') }}>*/
/*     {% else %}*/
